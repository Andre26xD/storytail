<?php
	...
	$query = "SELECT books.*, authors.id_author, authors.first_name, authors.last_name, COUNT(id_page) AS paginas FROM authors, books, author_book, pages WHERE authors.id_author = author_book.id_author AND books.id_book = author_book.id_book AND books.id_book = pages.id_book AND books.id_book='$id_book'";
